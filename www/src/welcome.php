...
<article>
    ...
    <p>Rédigé par <em><?php echo htmlspecialchars($News->getAuthor(), ENT_QUOTES, 'utf-8'); ?></em> le <?php echo htmlspecialchars(strftime('%A %e %B %G à %H:%M', $News->getDateAdded()->getTimestamp()), ENT_QUOTES, 'utf-8'); ?></p>
